--
-- Fibaro - Eric Hania
-- Kevin Mode - Virtual Device - Toggle
-- Date: 10/02/2019
-- Time: 10:02
--
...
if isKevinMode:getValue() then
	logger:log("action", "Setting Kevin Mode OFF...")
	isKevinMode:setGlobalValue(false)
else
	logger:log("action", "Setting Kevin Mode ON...")
	isKevinMode:setGlobalValue(true)
end
